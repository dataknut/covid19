...
```{r plotAllDeaths, fig.cap="USA recorded deaths by flu season (all deaths)"}
...
```{r plotPneuDeaths, fig.cap="USA recorded Pneumonia deaths by flu season"}
...
```{r plotFluDeaths, fig.cap="USA recorded Influenza deaths by flu season"}
